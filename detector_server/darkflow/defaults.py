class argHandler(dict):
    ...
    def setDefaults(self):
        ...
        self.define('model', '../cfg/tiny-yolo-voc-24c.cfg', 'configuration of choice')
        ...
        self.define('load', 127928, 'how to initialize the net? Either from .weights or a checkpoint, or even from scratch')
        ...
        self.define('batch', 32, 'batch size')
        ...
        self.define('client_camera', True, 'demo client and server')
